...
namespace Astra.Manager.Tests.CountryManager
{
    public class UpdateCountryAsyncShould
    {
        ...
        public async Task Returns_failure_when_name_is_missing()
        {
            ...
            var result = await countryManager.UpdateCountryAsync(country, CancellationToken.None);
            ...
            _countryRepository.Verify(r => r.UpdateAsync(It.IsAny<Country>(), It.IsAny<CancellationToken>()), Times.Never);
        }
        ...
        [Fact]
        public async Task Updates_country_successfully()
        {
            ...
            _countryRepository.Verify(r => r.FindAsync(It.IsAny<ISpecification<Country>>(), It.IsAny<CancellationToken>()), Times.Once);
            _countryRepository.Verify(r => r.UpdateAsync(country, It.IsAny<CancellationToken>()), Times.Once);
        }
    }
